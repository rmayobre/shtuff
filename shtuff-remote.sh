...
source <(curl -sL "${BASE_URL}/src/containers/pct_next_vmid.sh")
source <(curl -sL "${BASE_URL}/src/containers/lxc_network.sh")
source <(curl -sL "${BASE_URL}/src/containers/pct_network.sh")
source <(curl -sL "${BASE_URL}/src/containers/lxc_network_show.sh")
source <(curl -sL "${BASE_URL}/src/containers/pct_network_show.sh")
source <(curl -sL "${BASE_URL}/src/containers/container_network_prompt.sh")
source <(curl -sL "${BASE_URL}/src/containers/lxc_shell_script.sh")
source <(curl -sL "${BASE_URL}/src/containers/pct_shell_script.sh")
source <(curl -sL "${BASE_URL}/src/containers/container_prompt.sh")
source <(curl -sL "${BASE_URL}/src/containers/pct_find_vmid.sh")
source <(curl -sL "${BASE_URL}/src/containers/container.sh")
source <(curl -sL "${BASE_URL}/src/containers/container_script.sh")
